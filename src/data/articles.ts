...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Annual storage and insurance costs are typically modest, usually a small percentage of cask value, often a few tens of pounds per cask per year for storage plus a separate insurance line. Specific costs depend on the warehouse, the cask type and the insured value.",
  ...
  },
  {
    ...
    category: "Distillery News",
    date: "March 2026",
    title: "Port Ellen Is Producing Spirit Again: Islay Has Its Ghost Distillery Back",
    excerpt:
