...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      "The Scotch Whisky Association welcomed the UK Government's confirmation on 17 June 2026 that the UK–India Free Trade Agreement will enter into force the following month. Mark Kent, the SWA's Chief Executive, described the announcement as 'welcome news, given the strategic importance' of India to the Scotch whisky industry.",
      "Under the terms of the deal, India's long-standing 150% tariff on imported Scotch will drop to 75% on day one, with further reductions phased in over the following decade. India is already the largest export market for Scotch by volume, taking the equivalent of more than 192 million bottles in 2024 according to SWA data.",
      "In a briefing published on the SWA website, Kent noted that the Indian middle class continues to expand rapidly and that premiumisation trends increasingly favour imported single malts and blends. Speaking to reporters in November 2025, he went further, describing India as 'poised to become the largest global scotch market in value and volume terms' over the next few years.",
  ...
  },
  {
    ...
    content: [
      "At a live auction on 10 March 2026, Christie's London sold two casks from the closed Japanese distillery Karuizawa for £2,125,000 each. Together the pair fetched £4.25 million, or roughly US$5.65 million at the time. The result, reported by The Spirits Business, The Whiskey Wash and WhiskeyPulse, is a new record for the auction house for a whisky cask sale.",
      ...
      "The two casks sold in March, Nos. 6195 and 888, are believed to be among the last full casks of Karuizawa ever to reach the open market. Christie's specialists noted that the sale reflected sustained interest at the very top of the market from Asian and European collectors, even as prices for more mainstream collectible bottlings have cooled from their 2022 highs.",
      "Broker Mark Littler, writing in a mid-2026 market outlook, argued that after several years of correction across luxury assets the cask market has entered a 'steadier place'. Headline auction results such as Karuizawa, he suggested, continue to draw serious buyers back to genuinely rare, well-documented stock.",
  ...
  },
  {
    ...
    content: [
      ...
      "Steam is central to whisky production because it is used to heat the wash and spirit stills. Traditionally that heat has come from natural gas or heavy fuel oil, making it one of the largest sources of carbon emissions in a modern distillery. Replacing those fuels with stored renewable electricity offers a credible route to substantially lower-carbon distilling.",
      "Annandale is not alone in its ambitions. The proposed HyClyde project at Auchentoshan is exploring on-site green hydrogen production, InchDairnie in Fife has published a detailed sustainability timeline covering thermal vapour recompression and other efficiency measures, and Beam Suntory-backed 'WhiskHy' trials with Supercritical Solutions have been reported through the UK Government's Green Distilleries competition.",
  ...
  },
  {
    ...
    content: [
      ...
      "Both anniversary expressions, the 50 Year Old and an accompanying 10 Year Old Distillery Exclusive, were matured entirely at Pulteney Distillery in Wick. That is an unusually strong provenance claim given how much modern Scotch is transported for warehousing elsewhere in Scotland. The releases were also covered by The Whisky Wire and The Herald, whose reporter visited the distillery to try the anniversary bottlings on site.",
      ...
      "Very old age statements from working distilleries, particularly at 40, 50 and beyond, are among the rarest categories of Scotch. Because casks lose volume to evaporation each year (the so-called 'angels' share'), what remains of a fifty-year-old cask is typically only a fraction of the original fill, which is a key reason why bottles from these releases command significant premiums.",
  ...
  },
  {
    ...
    content: [
      ...
      "Limited commemorative releases like the James Hutton bottling illustrate a pattern common to a well-run modern distillery. The producer builds out its core range, then issues small parcels of older or specially cask-finished whisky that reinforce the brand's premium positioning. Over time, these limited editions help establish stronger secondary-market pricing for the distillery's broader inventory.",
      ...
      "For cask investors, distilleries with a consistent record of well-received limited releases are often attractive because they demonstrate active brand-building. That, in turn, tends to support demand for their aged stock as it comes to market.",
