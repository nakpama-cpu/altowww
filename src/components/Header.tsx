    ...
    >
      <div className="max-w-6xl mx-auto px-4 lg:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-0 lg:gap-1 xl:gap-2">
            ...
            link.children ? (
              <div key={link.label} className="relative" ref={dropdownRef}>
                <button
                  ...
                  className={`px-2 py-2 lg:px-3 xl:px-4 font-body text-[10px] tracking-[0.15em] lg:text-xs lg:tracking-[0.2em] uppercase whitespace-nowrap transition-all duration-300 flex items-center gap-1 ${
                    isAboutActive
                      ? "text-primary"
              ...
              >
                <Link
                  ...
                  className={`px-2 py-2 lg:px-3 xl:px-4 font-body text-[10px] tracking-[0.15em] lg:text-xs lg:tracking-[0.2em] uppercase whitespace-nowrap transition-all duration-300 inline-block ${
              ...
              <Link
                key={link.to}
                to={link.to!}
                className={`px-2 py-2 lg:px-3 xl:px-4 font-body text-[10px] tracking-[0.15em] lg:text-xs lg:tracking-[0.2em] uppercase whitespace-nowrap transition-all duration-300 ${
                  isActive(link.to!)
                    ? "text-primary"
                    : "text-secondary-foreground/60 hover:text-secondary-foreground"
                }`}
          ...
          <button onClick={() => setLoginOpen(true)} className="px-2 py-2 lg:px-3 xl:px-4 font-body text-[10px] tracking-[0.15em] lg:text-xs lg:tracking-[0.2em] uppercase whitespace-nowrap text-secondary-foreground/60 hover:text-secondary-foreground">Client Login</button>
          <BrochureButton className="hidden lg:inline-flex items-center px-3 py-2 lg:px-4 font-body text-[10px] tracking-[0.15em] lg:text-xs lg:tracking-[0.2em] uppercase bg-primary text-primary-foreground hover:opacity-90 transition-opacity whitespace-nowrap" />
        </nav>
