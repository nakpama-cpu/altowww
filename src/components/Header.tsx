    ...
    >
      <div className="max-w-6xl mx-auto px-4 lg:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-0 lg:gap-1 xl:gap-2">
          ...
          <BrochureButton className="hidden xl:inline-flex items-center px-3 py-2 lg:px-4 font-body text-[10px] tracking-[0.15em] lg:text-xs lg:tracking-[0.2em] uppercase bg-primary text-primary-foreground hover:opacity-90 transition-opacity whitespace-nowrap" />
        </nav>
