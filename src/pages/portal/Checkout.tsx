    ...
    return (
      <div className="max-w-6xl w-full min-w-0">
        ...
        <div className="grid lg:grid-cols-5 gap-6 min-w-0 items-start">
          <aside className="lg:col-span-2 bg-surface border border-border shadow-sm rounded-sm p-6 min-w-0">
      ...
      <div className="grid lg:grid-cols-3 gap-6 min-w-0">
        <div className="lg:col-span-2 space-y-3 min-w-0">
          {lineBreakdown.map(({ item: i, unit, lineTotal, palletActive }) => {
            ...
            return (
              <div key={i.listing_id} className="bg-surface border border-border shadow-sm rounded-sm p-3 sm:p-4">
        ...
        <aside className="bg-surface border border-border shadow-sm rounded-sm p-6 h-fit min-w-0">
