...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-6xl">
      ...
      {/* Hero portfolio card */}
      <div className="bg-secondary border border-secondary-foreground/10 text-secondary-foreground rounded-sm p-8 md:p-10 mb-6 relative overflow-hidden">
...
const QuickAction = ({ to, icon: Icon, label, sub }: { to: string; icon: any; label: string; sub: string }) => (
  <Link to={to} className="group block bg-surface border border-border p-6 hover:border-primary transition-colors">
