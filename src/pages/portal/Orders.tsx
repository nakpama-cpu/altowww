  ...
  return (
    <div className="max-w-4xl">
      ...
      {loading ? (
        ...
        <div className="p-12 text-center rounded-sm bg-surface border border-border shadow-sm rounded-sm">
        ...
        <div className="space-y-4">
          {filteredRows.map((o) => (
            <div key={o.id} className="rounded-sm bg-surface border border-border shadow-sm rounded-sm overflow-hidden">
              <button
                type="button"
