    ...
    <div className="max-w-7xl">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-12 gap-2 lg:gap-6 mb-6 w-full">
        ...
        <select
          ...
          className="w-full h-10 px-3 border border-border bg-card font-body text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 min-w-0 md:col-span-2 lg:col-span-2 md:order-7 lg:order-none"
        >
