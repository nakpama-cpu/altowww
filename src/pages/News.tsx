...
const News = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Hero */}
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 section-light">
        <div className="max-w-5xl mx-auto px-6 md:px-12">
          <p className="chapter-marker mb-6 text-muted-foreground/50 animate-fade-in">
            News & Insights
          </p>
          <h1 className="display-heading text-4xl md:text-6xl animate-fade-in-up">
            Articles & Market Updates
          </h1>
          <p
            className="mt-6 font-body text-base text-muted-foreground max-w-lg leading-relaxed animate-fade-in-up"
